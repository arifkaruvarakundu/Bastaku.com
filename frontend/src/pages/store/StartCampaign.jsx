...
const StartCampaignPage = () => {
  ...
  useEffect(() => {
    ...
    if (storedProduct && start_campaign_details) {
      ...
      let calculatedPrice =
        (storedProduct.actual_price * (100 - storedProduct.campaign_discount_percentage)) / 100;
      ...
      setProgress((storedQuantity / storedProduct.minimum_order_quantity_for_offer) * 100);
    } else {
  ...
  const increaseQuantity = () => {
    if (quantity < product.stock) {
      ...
      setProgress((newQuantity / product.minimum_order_quantity_for_offer) * 100);
    }
  };
  ...
  const handleStartCampaign = async () => {
    ...
    try {
      ...
      const response = await axios.post("http://127.0.0.1:8000/start_campaign/", data, config);
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
          ...
          <div style={{ display: "flex", gap: "20px", alignItems: "flex-start" }}>
            ...
            <div style={{ flex: "1 1 60%" }}>
              <p><strong>Minimum Order Quantity for Offer:</strong> {product.minimum_order_quantity_for_offer} Kg</p>
                ...
                <div>
                    ...
                    <p style={{ textAlign: "center", marginTop: "5px" }}>
                        {progress >= 100
                            ...
                            : `${Math.max(0, (product.minimum_order_quantity_for_offer - quantity).toFixed(2))} Kg more to unlock!`} 
